...
class appAddTask extends RootElement {
  ...
  renderData() {
    this.innerHTML = `
      <input type="text" id="task" placeholder="your new task" value="check for brain"></input>
  ...
  generateTask() {
    let tasks = ['watch GOT', 'check FB', 'wash dishes', 'refine plans for Death Star', 'invent killer app', 'practice sarcasm', 'make fun of hipsters', 'drink more coffee','google "moron detector"'];
